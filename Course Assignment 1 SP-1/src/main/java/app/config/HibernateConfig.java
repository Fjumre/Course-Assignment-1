...
public class HibernateConfig {
    ...
    private static EntityManagerFactory setupHibernateConfigurationForTesting() {
        try {
            ...
            props.put("hibernate.connection.url", "jdbc:tc:postgresql:15.3-alpine3.18:///hobby");
            props.put("hibernate.connection.username", "postgres");
            props.put("hibernate.connection.password", "postgres");
    ...
    public static EntityManagerFactory getEntityManagerFactory(boolean isTrue, String Database){
        if (isTrue==true) getEntityManagerFactoryConfigTest();
